...
## Projeto: Controle de Imposto de Renda
...
- Padronização e validação dos dados bancários por meio de tabelas de referência
- Proteção de células e abas para evitar alterações indevidas e garantir a segurança das informações


### Competências Técnicas Demonstradas
- Estruturação lógica de planilhas com separação por temas e funções
- Aplicação de formatação avançada (bordas, cores, títulos) para facilitar a navegação e o entendimento visual
- Implementação de fórmulas automáticas para totalização de valores e saldos
